...
if __name__ == "__main__":
    ...
    parser.add_argument("--dryrun", action="store_true", help="Run 1 gen/2 pop dry run (no plots, no injection)")
    ...
    if args.dryrun:
        NUM_GENERATIONS = 1
        POPULATION_SIZE = 2
        print("[DRY RUN] 1 generation, 2 population, no plots or injection")
    else:
